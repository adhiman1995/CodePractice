...
import { Mail, Lock, Sparkles, ArrowRight, Loader2, Code2 } from 'lucide-react';
import API_BASE_URL from '../config';

export default function Login({ setAuthToken, setUserProfile, onNavigateToSignup }) {
    ...
    return (
        <div className="h-screen w-full bg-orange-400 flex items-center justify-center p-6 relative overflow-hidden">
            ...
            <div className="absolute top-0 right-0 w-[800px] h-[800px] bg-white/10 rounded-full -translate-y-1/2 translate-x-1/2 blur-[120px]"></div>
            <div className="absolute bottom-0 left-0 w-[600px] h-[600px] bg-black/5 rounded-full translate-y-1/2 -translate-x-1/2 blur-[100px]"></div>
            ...
            <div className="w-full max-w-md bg-white rounded-[2.5rem] shadow-[0_20px_50px_rgba(0,0,0,0.15)] p-10 relative z-10 transition-all duration-500 hover:shadow-[0_40px_80px_rgba(0,0,0,0.2)]">
                <div className="flex flex-col items-center mb-10">
                    ...
                    <p className="text-gray-400 text-xs font-bold uppercase tracking-widest mt-2">Welcome Back</p>
                </div>
                ...
                <form onSubmit={handleLogin} className="space-y-6">
                    <div>
                        ...
                        <div className="relative group">
                            <div className="absolute inset-y-0 left-0 pl-4 flex items-center pointer-events-none transition-colors duration-300 group-focus-within:text-orange-500">
                            ...
                            <input
                                ...
                                className="block w-full pl-12 pr-4 py-4 bg-gray-50 border border-gray-100 rounded-2xl leading-5 text-gray-900 placeholder-gray-300 focus:outline-none focus:ring-2 focus:ring-orange-500/10 focus:border-orange-500/50 sm:text-sm transition-all duration-300"
                    ...
                    <div>
                        <div className="flex items-center justify-between mb-2 px-1">
                            ...
                            <a href="#" className="text-[10px] font-black text-orange-500 hover:text-orange-600 uppercase tracking-widest transition-colors">Forgot Password?</a>
                        </div>
                        <div className="relative group">
                            <div className="absolute inset-y-0 left-0 pl-4 flex items-center pointer-events-none transition-colors duration-300 group-focus-within:text-orange-500">
                ...
                <div className="mt-10 pt-8 border-t border-gray-50 text-center">
                    <p className="text-xs font-bold text-gray-400 uppercase tracking-widest leading-relaxed">
                        No Account?{' '}
                        <button onClick={onNavigateToSignup} className="text-orange-500 hover:text-orange-600 transition-colors ml-1">
                            Register
                        </button>
                    </p>
                </div>
